...
public class Deposito {
	...
	public void moverStock(String origen, String destino, Producto prod,
			float cant, String solicitante, String responsable, boolean entrante)
			throws Exception {
		MovStock mov = new MovStock(origen, destino, prod, solicitante,
				responsable, cant, entrante);
		if (entrante)
